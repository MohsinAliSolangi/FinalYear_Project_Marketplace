                    ...
                    <div className="flat-tabs tab-authors">
                        <div className="author-profile flex">
                            ...
                            <div className="infor-profile">
                                ...
                                <form>
                                    <input type="text" className="inputcopy" readOnly />
                                    {/* {account ? 
                                    <button type="button" className="btn-copycode">{account.slice(0,18)}<i className="icon-fl-file-1"></i></button>
                                    : */}
                            ...
                            <div style={{marginLeft: "700px"}}>
                              <h2 className="title">Your NFT's</h2>
                              </div>
                            <div className="content-tab">
                                <div className="content-inner">
                                    ...
                                    purchases.map((item, index) => (
                                        <NbftCard  item={item} index={index} />
                                       ))
                                    }
                                    </div>
                                </div>
